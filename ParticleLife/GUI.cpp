...
template<>
void GUI<EventType::WINDOW_RESIZE>::registerToHandler(GUIEventHandler& handler)
{
	handler.registerWindowResizeCallback(std::bind(&GUI::update, this, std::placeholders::_1, std::placeholders::_2));
}
...
template<>
void GUI<static_cast<EventType>(EventType::MOUSE_CLICK | EventType::MOUSE_MOVE | EventType::WINDOW_RESIZE)>::registerToHandler(GUIEventHandler& handler)
{
	handler.registerMouseClickCallback(std::bind(&GUI::update, this, std::placeholders::_1, std::placeholders::_2));
	handler.registerMouseMoveCallback(std::bind(&GUI::update, this, std::placeholders::_1, std::placeholders::_2));
	handler.registerWindowResizeCallback(std::bind(&GUI::update, this, std::placeholders::_1, std::placeholders::_2));
